...
| **Transformations** | Data transformations with undo capability | `DatasetTransformationModule` | Extracted to `views-reporting` (ADR-054). Re-export shim in `modules/transformations/` | Stable |
