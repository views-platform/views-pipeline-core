# ADR-030: Orchestrator-Led Data Alignment & PredictionFrame Standard
...
- **Explicit Metadata**: All spatiotemporal identifiers must be explicitly provided (as per ADR-031).
