...
def mock_client():
    ...
    with patch("views_pipeline_core.managers.appwrite.Client") as mock:
...
def mock_storage():
    ...
    with patch("views_pipeline_core.managers.appwrite.Storage") as mock:
...
def mock_databases():
    ...
    with patch("views_pipeline_core.managers.appwrite.Databases") as mock:
        yield mock.return_value
...
def mock_account():
    ...
    with patch("views_pipeline_core.managers.appwrite.Account") as mock:
        yield mock.return_value
...
class TestSessionAuth:
    def test_setup_success(self, mock_client, mock_account):
        ...
        with patch("views_pipeline_core.managers.appwrite.Account", return_value=mock_account):
            result = auth.setup(
                mock_client,
...
class TestAppWriteFileManager:
    ...
    def file_manager(self, api_key_config):
        with patch("views_pipeline_core.managers.appwrite.Client"), \
             patch("views_pipeline_core.managers.appwrite.Storage"), \
             patch("views_pipeline_core.managers.appwrite.Databases"), \
             patch("views_pipeline_core.managers.appwrite.Users"):
    ...
    def test_upload_file_success(self, file_manager, tmp_path):
        ...
        with patch("views_pipeline_core.managers.appwrite.InputFile"):
...
class TestErrorHandling:
    def test_appwrite_exception_handling(self, api_key_config):
        with patch("views_pipeline_core.managers.appwrite.Client"), \
             patch("views_pipeline_core.managers.appwrite.Storage") as mock_storage, \
             patch("views_pipeline_core.managers.appwrite.Databases"), \
             patch("views_pipeline_core.managers.appwrite.Users"):
