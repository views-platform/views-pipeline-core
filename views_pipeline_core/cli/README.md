...
### Purpose
Concrete argument set for the end‑to‑end forecasting pipeline: training, evaluation, forecasting, reporting, and optional operational features (prediction store, drift test, monthly shortcut).
...
| `update_viewser` | bool | False | **Retired 2026-09-16** — parses, then refused at argument validation (ADR-062); removed at 4.0. |
